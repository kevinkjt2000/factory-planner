...
func (tx *Tx) init() {
	...
	tx.RecipeItemOutputs = NewRecipeItemOutputsClient(tx.config)
	tx.RecipeType = NewRecipeTypeClient(tx.config)
}
...
// applies a query, for example: Recipe.QueryXXX(), the query will be executed
